...
public class ChannelStateTransformation {
    ...
    public final TransformationServiceProvider provider;
    protected WeakReference<@Nullable TransformationService> transformationService = new WeakReference<>(null);
