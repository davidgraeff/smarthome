...
public class ValueFactory {
    ...
    public static Value createValueState(ChannelConfig config, String channelTypeID) {
        ...
        switch (channelTypeID) {
            ...
            case MqttBindingConstants.NUMBER_ANGLE:
            case MqttBindingConstants.NUMBER_INTENSITY:
            case MqttBindingConstants.NUMBER_LENGTH:
            case MqttBindingConstants.NUMBER_PRESSURE:
            case MqttBindingConstants.NUMBER_SPEED:
            case MqttBindingConstants.NUMBER_TEMP:
