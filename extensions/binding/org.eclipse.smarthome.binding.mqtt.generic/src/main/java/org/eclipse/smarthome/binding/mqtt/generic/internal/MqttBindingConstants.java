...
public class MqttBindingConstants {
    ...
    public static final String NUMBER_TEMP = "NumberTemperature";
    public static final String NUMBER_PRESSURE = "NumberPressure";
    public static final String NUMBER_SPEED = "NumberSpeed";
    public static final String NUMBER_INTENSITY = "NumberIntensity";
    public static final String NUMBER_ANGLE = "NumberAngle";
